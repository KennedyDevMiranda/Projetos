        ...
        private static async Task CreateTablesIfNotExistsAsync()
        {
            ...
            var teste = @"
                CREATE TABLE IF NOT EXISTS mensagens_agendadas (
                    ...
                    Mensagem TEXT NOT NULL,
                    DataHoraAgendada TEXT NOT NULL, -- ISO yyyy-MM-dd HH:mm:ss
                    Ativo INTEGER NOT NULL DEFAULT 1,
                    Status TEXT NOT NULL DEFAULT 'Pendente',
                ...
                CREATE INDEX IF NOT EXISTS idx_mensagens_agendadas_datahora
                ON mensagens_agendadas (DataHoraAgendada);

                CREATE INDEX IF NOT EXISTS idx_mensagens_agendadas_status
                ON mensagens_agendadas (Status, Ativo);";
